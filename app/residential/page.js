      ...
      <section className="bg-blueprint text-paper">
        <div className="mx-auto max-w-4xl px-6 py-20 text-center">
          <p className="font-display text-2xl font-medium leading-snug md:text-3xl">
            Every homeowner gets the same six-step process: free estimate, in-home consultation,
            precise measurement, material selection, a walkthrough before we start, and a job site you
            always understand.
          </p>
        </div>
      </section>
